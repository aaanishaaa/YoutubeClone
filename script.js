...
const handleSearch =(event)=>
{
    ...
    const key=document.querySelector("#search-text").value;
    window.open(`./search.html?key=${key}`,"_top");
...
const showUI=(list)=>
{
    ...
    // const handleHover=(event,idx)=>{

    //     // handle 
    // };
    const handeCardClick=(element)=>{
